...
document.write("<script language=\"JavaScript\" src=\"../Titles.js\" charset=\"" + Charset + "\"><\/script>");
...
{
	document.writeln(STR_FORM_SEARCHFOR + " <input type=\"text\" name=\"zoom_query\" size=\"60\" value=\"" + htmlspecialchars(query) + "\" id=\"zoom_searchbox\" class=\"zoom_searchbox\" />");
}

function ZoomShowSearchButton()
{
	document.writeln("<br /><br /><input type=\"submit\" value=\"" + STR_FORM_SUBMIT_BUTTON + "\" class=\"zoom_button\" />");
}
...
function ZoomShowResults()
{
	...
	while (arrayline < matches && arrayline < result_limit) {
		...
		urlLink = pgurl;
		if (arrayline % 2 == 0)
			document.writeln("<br /><div class=\"result_block\">");
		else
			document.writeln("<br /><div class=\"result_altblock\">");
		...
		var END = pgurl.lastIndexOf("/");
		var DIR = pgurl.slice(0,END);
		
		document.writeln("<a href=\"../../../" + pgurl + "\"" + target + ">" + Title + "</a><br>Directory: <a href=\"../../../" + DIR + "\"" + target + ">" + DIR + "</a>");
	...
	document.writeln("</div><br />"); // end results style tag
}
...
function ZoomShowPagesCount()
{
	...
	if (num_pages > 1)
		document.writeln("<div class=\"result_pagescount\">" + num_pages + " " + STR_PAGES_OF_RESULTS + "</div>\n");
}
